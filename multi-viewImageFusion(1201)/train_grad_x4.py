...
if __name__ == "__main__":
    ...
    tb = TensorBoardX(config_filename = "config/train_config.py", code_filename="train_grad_x4.py", output_path=config.OUT['path'] , sub_dir="grad")
    ...
    # config.DATA["resume"] = '/home/disk60t/jjq/imgFusion/pixelFusionNet//naive/2021-02-10T10:20:55.342608' #31.798531(580/600epoch)
    ...
    for epoch in range(last_epoch+1, config.DATA["num_epochs"]):
        ...
        for batch_idx, batch in enumerate(train_dataloader):
            ...
            # regularization_loss1 = 5e-3*regularizationLoss1(delta_flows)
            ## gradLoss
            ...
            fusion_loss = reconstruction_loss + warping_loss + regularization_loss + grad_loss + grad_branch_loss# + regularization_loss1
            ...
            pbar.set_postfix(Train_Loss = fusion_losses.avg, Current_Loss=fusion_loss.item(), Rec=reconstruction_loss.item(), 
                            Warp=warping_loss.item(), Reg=regularization_loss.item())#, Reg1=regularization_loss1.item()

        print('epoch:{}, 1*recons:{}, 1*warp:{}, 5e-3*reg:{}, grad:{}, grad_branch:{}, fusionLoss:{}'.format(epoch, 1*reconstruction_loss, 
                    1*warping_loss, regularization_loss, grad_loss, grad_branch_loss, fusion_loss), file=loss_file) #, regularization_loss1
